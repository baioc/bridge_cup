...
public class CopaActivity extends AppCompatActivity {
    ...
    private static final String TAG = CopaActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //@todo melhorar formatacao do layout de cada Card de Grupo e do Layout dos Grupos no geral
        ...
        connectAndGetGrupos(ANO);//@fixme alguns icones nao carregam
    }
